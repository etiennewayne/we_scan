<?php
include ('header.php');
$client_id = $db->addqoute($_GET['client_id']);
$population = $db->row('population', "population_id=$client_id");
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-2 d-flex justify-content-between align-items-center">
                <div class="h5">Log History</div>
                <a href="population-view.php?population_id=<?= $_GET['client_id']; ?>" class="btn btn-primary">Back</a>
            </div>
            <div class="mb-3 p-2 border">
                <?= $_GET['client_id']; ?> <br />
                <?= $population->firstname . ' ' . $population->middlename . ' ' . $population->lastname; ?><br />
                <?= $population->purok.', '.$population->barangay.', Tangub City'; ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="nav  nav-pills" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">People Contact</button>
                </li>
            </ul>
