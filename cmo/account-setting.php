    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <table class="table border mt-3">
                ...
                <tr>
                    <td colspan="2">
                        <button class="btn btn-sm btn-primary mb-1" data-bs-toggle="modal" data-id="<?= $cmo->user_id; ?>" data-bs-target="#editNameModal">Edit Name</button>
                        <button class="btn btn-sm btn-primary mb-1" data-bs-toggle="modal" data-id="<?= $cmo->user_id; ?>" data-bs-target="#editUserNameModal">Change Username</button>
                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-id="<?= $cmo->user_id; ?>" data-bs-target="#editPasswordModal">Change Password</button>
                    </td>
                </tr>
            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="user_id" value="<?= $cmo->user_id; ?>">
                <div class="p-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="fullname" placeholder="Fullname" value="<?= $cmo->account_name; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="p-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="username" placeholder="Username" value="<?= $cmo->username; ?>">
