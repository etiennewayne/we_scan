    ...
    <div class="login-container d-flex justify-content-center align-items-center">
        <div class="login-field shadow bg-white p-5">
            <div class="text-center mb-4">
                <img src="<?php echo BASE_URL; ?>includes/images/avatar.png" width="100" height="100" alt="" />
                <div class="mt-3 h5 text-secondary">Tourism Login</div>
            </div>
            <form action="verify.php" method="post">
                ...
                <div class="d-flex align-items-center">
                    <span></span>
                    <button id="submit" class="btn btn-primary ms-auto">Login</button>
                </div>
            </form>
            <?php
