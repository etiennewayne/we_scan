...
<head>
    ...
    <title>
        <?php
            ...
            echo PROJECT_NAME . ' - TOURISM PAGE';
        ...
        <div class="container py-1">
            <div class="navbar-brand mb-0 h1">
                <div class="d-flex align-items-center">
                    ...
                    <div class="brand ms-3">
                        ...
                        <div class="h6 font-weight-normal">Tourism Page</div>
                    </div>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="mnuPopulation" href="population.php">Population</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="mnuEstablishments" href="establishments.php">Establishments</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="mnuTransportation" href="transportation.php">Transportation</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><span class="dropdown-item-text text-secondary"><?= $admin->account_name; ?></span></li>
